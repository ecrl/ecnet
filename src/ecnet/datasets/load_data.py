...
_DATA_PATH = path.join(path.dirname(path.abspath(__file__)), "data")
...
def load_bp(
    as_dataset: bool = False, backend: str = "padel"
) -> Union[Tuple[List[str], List[List[float]]], QSPRDatasetFromFile]:
    """
    Load boiling point data; target values given in Celsius

    Parameters
    ----------
    as_dataset : bool, optional
        If True, return a ``QSPRDatasetFromFile``; otherwise return SMILES and targets.
    backend : str, optional
        Descriptor backend: ``padel`` or ``alvadesc``.

    Returns
    -------
    tuple or QSPRDatasetFromFile
        SMILES/target pair or dataset object.
    """
...
def load_cn(
    ...
    """
    Load cetane number data; target values given in CN units
...
def load_cp(
    ...
    """
    Load cloud point data; target values given in Celsius
...
def load_kv(
    ...
    """
    Load kinematic viscosity data; target values given in mm^2/s (cSt) at 313 deg. K
...
def load_lhv(
    ...
    """
    Load lower heating value data; target values given in MJ/kg = kJ/g
...
def load_mon(
    ...
    """
    Load motor octane number data; target values given in MON units
...
def load_mp(
    ...
    """
    Load melting point data; target values given in Celsius
...
def load_pp(
    ...
    """
    Load pour point data; target values given in Celsius
...
def load_ron(
    ...
    """
    Load research octane number data; target values given in RON units
...
def load_ysi(
    ...
    """
    Load yield sooting index data; target values given in unified YSI units
